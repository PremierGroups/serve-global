      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">property Detail</h1>
				...
				<div class="row d-flex align-items-center justify-content-center">
                    <div class="col-lg-8 ftco-animate ">
                        ...
                        <h2 class="mb-3"><?php echo $title?></h2>
                            <div class="tab-content"  style=" padding:0px !important;margin:0px !important">
                                <div id="product1<?php echo $id?>" class="tab-pane fade in show active">
                                    <img class="col-lg-12 img-fluid img-responsive"  style=" padding:0px !important;margin:0px !important;height:407px !important" src="<?php echo '../images/property/'.$images[0]?>" />
                                </div>

                                <?php if(count($images)>1):?>
                                <div id="product2<?php echo $id?>" class="tab-pane fade">
                                    <img class=" col-md-12 d-flex align-items-center img-responsive" style=" padding:0px !important;margin:0px !important;height:407px !important" src="<?php echo '../images/property/'.$images[1]?>" >
                                </div>
                                <?php endif;?>
                                <?php if(count($images)>2):?>
                                <div id="product3<?php echo $id ?>" class="tab-pane fade">
                                    <img class=" col-md-12 d-flex align-items-center img-responsive" style=" padding:0px !important;margin:0px !important;height:407px !important" src="<?php echo '../images/property/'.$images[2]?>" >
                                </div>
                                <?php endif;?>
                                <div>
                                    <ul class="nav nav-tabs products-nav-tabs horizontal quick-view mt-10">
                                        <li style=" padding:0px !important;margin:0px !important"><a class="active" data-toggle="tab" href="#product1<?php echo $id ?>"><img src="<?php echo '../images/property/'.$images[0]?>" alt="" height="100px" width="100px" /></a></li>
                                        <?php if(count($images)>1):?>
                                            <li style=" padding:0px !important;margin:0px !important"><a data-toggle="tab" href="#product2<?php echo $id ?>"><img src="<?php echo '../images/property/'.$images[1]?>" alt="" height="100px" width="100px" /></a></li>
                                        <?php endif;?>
                                        <?php if(count($images)>2):?>
                                            <li style=" padding:0px !important;margin:0px !important"><a data-toggle="tab" href="#product3<?php echo $id ?>"><img src="<?php echo '../images/property/'.$images[2]?>" alt="" height="100px" width="100px"/></a></li>
                                        <?php endif;?>
                                    </ul>
                                </div>
                            </div>
