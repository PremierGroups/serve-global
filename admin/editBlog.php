...
if (isset($_REQUEST['blog-id'])) {
    ...
    $blogId = $row['id'];
    if (empty($row['id'])) {
        header("location:blogs?msg=Please select blog to edit.Blog not found!");
        exit(1);
    }
    $path = $row['coverImage'];
} else {
    $msg = 'Please select blog to edit';
    header("location:blogs?msg=Please select project to edit!");
    exit(1);
}
...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["coverImage"]["tmp_name"], $target_dir . $target_file)) {
            ...
            $coverImage = $path;
            $msg = "Sorry, there was an error while updating the Blog.";
        }
    }
    ...
    $blog = new Blog();
    if ($blog->updateBlog($id,$title,$description,$coverImage)) {
        $msg = "Blog is Updated Successfully!";
    } else {
        $msg = "Failed to update Blog.Try again!";
    }
                ...
                <section class="content container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            ?>
                            <form class="form-horizontal" enctype="multipart/form-data" action="<?php $_PHP_SELF ?>" method="post" id="editBlogForm">
                            <div class="panel panel-default"> 
                                <div class="panel-body"><h4>Edit Blog</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <a href="#" data-image="../images/blog/<?php echo "$path"; ?>" class="btn btn-link view-image">View Image</a>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" class="btn btn-primary" name="updateBlogBtn">Update</button>
...
?>
        ...
        // To make Pace works on Ajax calls
                ...
                $('#editBlogForm').bootstrapValidator({
