...
if (isset($_GET['region_id']) && !empty(trim($_GET['region_id']))) {
    $region = trim($_GET['region_id']);
}
...
if (isset($_GET['getReport'])) {
    ...
    $gender = $_GET['gender'];
    header("location:viewVolunteersByRegion?region_id=$regions&gender=$gender");
    exit(1);
}
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>View Volunteers By Region | VMS</title>
            ...
            <div class="content-wrapper">
                    ...
                    <div class="no-print">
                        <form class="form-inline form-group" role="form" id="reportForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <div class="input-group date ">
                                ...
                                <select class="form-control select2" name="region[]"  id="countryInput" multiple="multiple" style="width:100%;">                                   
                                    <?php
                                    $region = ltrim(trim($region), ",");
                                    if (empty($region)) {
                                        ?>
                ...
                <section class="invoice">
                    ...
                    <section class="col-sm-12 invoice-col" style="background-color: #245269;">
                        ...
                        <h3  style="color: white;"><span class="col-sm-offset-3">Volunteers By Region</span></h3>
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $volunteers = $userObj->getVolunteersByRegion($rgn, $gender);
