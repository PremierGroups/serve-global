...
if (isset($_GET['subcity_id']) && !empty(trim($_GET['subcity_id']))) {
    $zone = trim($_GET['subcity_id']);
}
...
if (isset($_GET['getReport'])) {
    ...
    $zones = ltrim(trim($zones), ",");
    $gender = $_GET['gender'];
    header("location:viewVolunteersBySubCity?subcity_id=$zones&gender=$gender");
    exit(1);
}
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>View Volunteers By Sub-City | VMS</title>
            ...
            <div class="content-wrapper">
                    ...
                    <div class="no-print">
                        <form class="form-inline form-group" role="form" id="reportForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <div class="input-group date ">
                                ...
                                <select class="form-control select2" name="zone[]"  id="countryInput" multiple="multiple" style="width:100%;">                                   
                                    <?php
                                    $zone = ltrim(trim($zone), ",");
                                    if (empty($zone)) {
                                        ?>
                ...
                <section class="invoice">
                    ...
                    <section class="col-sm-12 invoice-col" style="background-color: #245269;">
                        ...
                        <h3  style="color: white;"><span class="col-sm-offset-3">Volunteers By Sub-City</span></h3>
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $volunteers = $userObj->getVolunteersBySubCity($subcty, $gender);
